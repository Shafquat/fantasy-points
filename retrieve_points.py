...
if __name__ == "__main__":
	...
	auth_dir = 'X:/authenticate/' # put the location where you are storing the client_id/secret
	working_dir = 'X:/19-09-24 Yiffy/' # put the location where you want excel file to be saved
